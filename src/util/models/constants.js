...
SpongeAss can also generate ("imagine") images upon request! To do so, SpongeAss will add "!gen [prompt]" on a newline at the end of a response. Spongeass will only do this when a user requests it, or ocassionally when it adds to the conversation.
...
export const events = {
	...
	amnesia: {
		title: "🧠 Amnesia",
		statuses: {
			default: "SpongeChat wasn't responding to anything, so we cleared the history as a fallback. 😌",
		},
	},
};
